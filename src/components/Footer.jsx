...
const Footer = () => {
  const footerLinks = {
    products: [
      { name: '20X Healthcare', href: '#' },
      { name: 'Recruitbee', href: '#' },
      { name: 'FlockLink', href: '#' },
        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">BYTE RIVER</span>
            </div>
            
            <p className="text-gray-300 leading-relaxed">
              Your trusted partner for innovative business software solutions. 
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">hello@byteriver.tech</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-300">
                Get insights on healthcare technology and industry trends.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2025 Byte River Tech. All rights reserved.
            </div>
